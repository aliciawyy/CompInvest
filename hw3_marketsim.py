...
def read_orders(filename):
    ...
    # Create the data
    order_data = dict(date=ls_date, symbol=ls_symbol, transaction=ls_order)
...
def main(argv):
    ...
    # Read the order file
    unique_dates, unique_symbols, order_frame = read_orders(input_file)
    ...
    write_orders(portfolio, output_file)
